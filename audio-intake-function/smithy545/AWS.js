var AWS = (function() {
  ...
  return {
    ...
    request2: function(method, path, payload) {
      if (endpoint == undefined) { throw "Error: enpoint undefined" }
    ...
    /**
     * Sets new endpoint, ex. https://n4ax0z53s3.execute-api.us-east-2.amazonaws.com/dev
